    ...
    <div role="main" class="main">
                ...
                <ul>
                    <li data-transition="fade">
                        ...
                        <h1 class="tp-caption custom-secondary-font font-weight-bold text-color-light"
                            ...
                            data-start="800"
                            data-transform_in="y:[-300%];opacity:0;s:500;" style="font-size: 32px;"><?php echo trans_line('slider_slide1_title');?></h1>

                        <div class="tp-caption custom-secondary-font font-weight-bold text-color-light"
                             data-x="['left','left','left','left']" data-hoffset="['30','30','30','30']"
                             data-y="center" data-voffset="['-42','-42','-42','2']"
                             data-start="800"
                             data-transform_in="y:[-300%];opacity:0;s:500;" style="font-size: 42px;"><?php echo trans_line('slider_slide1_sub');?>
                        </div>
                    ...
                    <li data-transition="fade">
                        ...
                        <h1 class="tp-caption custom-secondary-font font-weight-bold text-color-light"
                            ...
                            data-y="center" data-voffset="['-80','-80','-80','-40']"
                            data-start="800"
                            data-transform_in="y:[-300%];opacity:0;s:500;" style="font-size: 32px;"><?php echo trans_line('slider_slide2_title');?></h1>

                        <div class="tp-caption custom-secondary-font font-weight-bold text-color-light"
                             data-x="['left','left','left','left']" data-hoffset="['30','30','30','30']"
                             data-y="center" data-voffset="['-42','-42','-42','2']"
                             data-start="800"
                             data-transform_in="y:[-300%];opacity:0;s:500;" style="font-size: 42px;"><?php echo trans_line('slider_slide2_sub');?>
                        </div>
                ...
                <div class="row">
                    <div class="col-sm-5 col-md-6">
                        <div class="looking-for-box">
                            <h2>- <span class="text-lg custom-secondary-font"><?php echo trans_line('slider_promo_title');?></h2>
                            <p><?php echo trans_line('slider_promo_sub');?></p>
                        </div>
                    </div>
                    <div class="col-sm-3 col-md-2">
                        <a class="text-decoration-none" href="tel:+55 4395 40 34" target="_blank" title="<?php echo trans_line('slider_promo_call');?>">
                    ...
                    <div class="col-sm-6 col-md-6">
                        ...
                        <div class="col-md-6">
                            <ul class="list list-icons list-icons-style-3 list-tertiary">
                                <li><i class="fa fa-chevron-right"></i> <?php echo trans_line('about_us_list_1');?></li>
                                <li><i class="fa fa-chevron-right"></i> <?php echo trans_line('about_us_list_2');?></li>
                                <li><i class="fa fa-chevron-right"></i> <?php echo trans_line('about_us_list_3');?></li>
                            </ul>
                        </div>
                        <div class="col-md-6">
                            <ul class="list list-icons list-icons-style-3 list-tertiary">
                                <li><i class="fa fa-chevron-right"></i> <?php echo trans_line('about_us_list_4');?></li>
                                <li><i class="fa fa-chevron-right"></i> <?php echo trans_line('about_us_list_5');?></li>
                                <li><i class="fa fa-chevron-right"></i> <?php echo trans_line('about_us_list_6');?></li>
                            </ul>
                        </div>
        ...
        <section class="section-secondary custom-section-padding">
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        <h2 class="font-weight-bold text-color-dark mb-md">- <?php echo trans_line('services_title');?></h2>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-4">
                        <a href="<?php echo base_url_lang();?>servicios/contabilidad"
                           ...
                           data-appear-animation-delay="0">
                            <div class="feature-box custom-feature-box feature-box-style-2">
                                ...
                                <div class="feature-box-info ml-md">
                                    <h4 class="font-weight-normal text-lg"><?php echo trans_line('services_list_1_title');?></h4>
                                    <p><?php echo trans_line('services_list_1_desc');?></p>
                                </div>
                            </div>
                        </a>
                    </div>
                        ...
                        <a href="<?php echo base_url_lang();?>servicios/asesoria-juridica"
                           ...
                           data-appear-animation-delay="100">
                            <div class="feature-box custom-feature-box feature-box-style-2">
                                ...
                                <div class="feature-box-info ml-md">
                                    <h4 class="font-weight-normal text-lg"><?php echo trans_line('services_list_2_title');?></h4>
                                    <p><?php echo trans_line('services_list_2_desc');?></p>
                                </div>
                            </div>
                        </a>
                    </div>
                        ...
                        <a href="<?php echo base_url_lang();?>servicios/recorridos-virtuales"
                           ...
                           data-appear-animation-delay="200">
                            <div class="feature-box custom-feature-box feature-box-style-2">
                                ...
                                <div class="feature-box-info ml-md">
                                    <h4 class="font-weight-normal text-lg"><?php echo trans_line('services_list_3_title');?></h4>
                                    <p><?php echo trans_line('services_list_3_desc');?></p>
                                </div>
                            </div>
                        </a>
                    </div>
                        ...
                        <a href="<?php echo base_url_lang();?>servicios/arquitectura-empresarial"
                           ...
                           data-appear-animation-delay="300">
                            <div class="feature-box custom-feature-box feature-box-style-2">
                                ...
                                <div class="feature-box-info ml-md">
                                    <h4 class="font-weight-normal text-lg"><?php echo trans_line('services_list_4_title');?></h4>
                                    <p><?php echo trans_line('services_list_4_desc');?></p>
                                </div>
                            </div>
                        </a>
                    </div>
                        ...
                        <a href="<?php echo base_url_lang();?>servicios/reclutamiento-de-TI"
                           ...
                           data-appear-animation-delay="400">
                            <div class="feature-box custom-feature-box feature-box-style-2">
                                ...
                                <div class="feature-box-info ml-md">
                                    <h4 class="font-weight-normal text-lg"><?php echo trans_line('services_list_5_title');?></h4>
                                    <p><?php echo trans_line('services_list_5_desc');?></p>
                                </div>
                            </div>
                        </a>
                    </div>
                        ...
                        <a href="<?php echo base_url_lang();?>servicios/desarrollo-de-software"
                           ...
                           data-appear-animation-delay="500">
                            <div class="feature-box custom-feature-box feature-box-style-2">
                                ...
                                <div class="feature-box-info ml-md">
                                    <h4 class="font-weight-normal text-lg"><?php echo trans_line('services_list_6_title');?></h4>
                                    <p><?php echo trans_line('services_list_6_desc');?></p>
                                </div>
                            </div>
                        </a>
                    </div>
                ...
                <div class="row">
                    <div class="col-md-12 center">
                        <a class="btn btn-borders custom-border-width btn-primary custom-border-radius font-weight-semibold text-uppercase"
                           href="<?php echo base_url_lang();?>servicios" title="<?php echo trans_line('services_button');?>"><?php echo trans_line('services_button');?></a>
                    </div>
                </div>
            </div>
        </section>
                        ...
                        <div class="owl-carousel owl-theme nav-bottom rounded-nav numbered-dots pl-xs pr-xs"
                            ...
                            <div>
                                <div class="custom-step-item">
                                    ...
                                    <div class="step-content">
                                        <h4 class="mb-xlg"><?php echo trans_line('strat_step_1_title');?><br> <strong><?php echo trans_line('strat_step_1_sub');?></strong></h4>
                            ...
                            <div>
                                <div class="custom-step-item">
                                    ...
                                    <div class="step-content">
                                        <h4 class="mb-xlg"><?php echo trans_line('strat_step_2_title');?><br> <strong><?php echo trans_line('strat_step_2_sub');?></strong></h4>
                            ...
                            <div>
                                <div class="custom-step-item">
                                    ...
                                    <div class="step-content">
                                        <h4 class="mb-xlg"><?php echo trans_line('strat_step_3_title');?><br> <strong><?php echo trans_line('strat_step_3_sub');?></strong></h4>
        ...
        <section class="section-secondary custom-section-padding-2">
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        <h2 class="font-weight-bold text-color-dark mb-md">- <?php echo trans_line('success_title');?></h2>
                    </div>
                </div>
            </div>
								...
								<span class="thumb-info custom-thumb-info-style-1 thumb-info-hide-wrapper-bg">
									...
									<span class="thumb-info-caption background-color-secondary p-md pt-xlg pb-xlg">
										<span class="custom-thumb-info-title">
											<span class="custom-thumb-info-name font-weight-semibold text-color-dark text-md"><?php echo trans_line('success_1_title');?></span>
											<span class="custom-thumb-info-desc font-weight-light"><?php echo trans_line('success_1_sub');?></span>
										</span>
                ...
                <div>
                    <a href="<?php echo base_url_lang();?>casos" class="text-decoration-none">
								<span class="thumb-info custom-thumb-info-style-1 thumb-info-hide-wrapper-bg">
									...
									<span class="thumb-info-caption background-color-secondary p-md pt-xlg pb-xlg">
										<span class="custom-thumb-info-title">
											<span class="custom-thumb-info-name font-weight-semibold text-color-dark text-md"><?php echo trans_line('success_2_title');?></span>
											<span class="custom-thumb-info-desc font-weight-light"><?php echo trans_line('success_2_sub');?></span>
										</span>
										<span class="custom-arrow"></span>
									</span>
								</span>
                ...
                <div>
                    <a href="<?php echo base_url_lang();?>casos" class="text-decoration-none">
								<span class="thumb-info custom-thumb-info-style-1 thumb-info-hide-wrapper-bg">
									...
									<span class="thumb-info-caption background-color-secondary p-md pt-xlg pb-xlg">
										<span class="custom-thumb-info-title">
											<span class="custom-thumb-info-name font-weight-semibold text-color-dark text-md"><?php echo trans_line('success_3_title');?></span>
											<span class="custom-thumb-info-desc font-weight-light"><?php echo trans_line('success_3_sub');?></span>
										</span>
										<span class="custom-arrow"></span>
									</span>
								</span>
                ...
                <div>
                    <a href="<?php echo base_url_lang();?>casos" class="text-decoration-none">
								<span class="thumb-info custom-thumb-info-style-1 thumb-info-hide-wrapper-bg">
									...
									<span class="thumb-info-caption background-color-secondary p-md pt-xlg pb-xlg">
										<span class="custom-thumb-info-title">
											<span class="custom-thumb-info-name font-weight-semibold text-color-dark text-md"><?php echo trans_line('success_4_title');?></span>
											<span class="custom-thumb-info-desc font-weight-light"><?php echo trans_line('success_4_sub');?></span>
										</span>
										<span class="custom-arrow"></span>
									</span>
								</span>
                ...
                <div>
                    <a href="<?php echo base_url_lang();?>casos" class="text-decoration-none">
								<span class="thumb-info custom-thumb-info-style-1 thumb-info-hide-wrapper-bg">
									...
									<span class="thumb-info-caption background-color-secondary p-md pt-xlg pb-xlg">
										<span class="custom-thumb-info-title">
											<span class="custom-thumb-info-name font-weight-semibold text-color-dark text-md"><?php echo trans_line('success_5_title');?></span>
											<span class="custom-thumb-info-desc font-weight-light"><?php echo trans_line('success_5_sub');?></span>
										</span>
										<span class="custom-arrow"></span>
									</span>
								</span>
                ...
                <div>
                    <a href="<?php echo base_url_lang();?>casos" class="text-decoration-none">
								<span class="thumb-info custom-thumb-info-style-1 thumb-info-hide-wrapper-bg">
									...
									<span class="thumb-info-caption background-color-secondary p-md pt-xlg pb-xlg">
										<span class="custom-thumb-info-title">
											<span class="custom-thumb-info-name font-weight-semibold text-color-dark text-md"><?php echo trans_line('success_9_title');?></span>
											<span class="custom-thumb-info-desc font-weight-light"><?php echo trans_line('success_9_sub');?></span>
										</span>
										<span class="custom-arrow"></span>
									</span>
								</span>
                                ...
                                <div class="col-xs-12 col-sm-12 col-md-10">
                                    <div class="testimonial custom-testimonial-style-1 testimonial-with-quotes mb-none">
                                        ...
                                        <div class="testimonial-author pull-left">
                                            <p><strong><?php echo trans_line('exp_1_name');?></strong><span class="text-color-primary"><?php echo trans_line('exp_1_name_sub');?></span>
                                            </p>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div>
                                ...
                                <div class="col-xs-12 col-sm-12 col-md-10">
                                    <div class="testimonial custom-testimonial-style-1 testimonial-with-quotes mb-none">
                                        ...
                                        <div class="testimonial-author pull-left">
                                            <p><strong><?php echo trans_line('exp_2_name');?></strong><span class="text-color-primary"><?php echo trans_line('exp_2_name_sub');?></span>
                                            </p>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <article class="blog-post">
                        ...
                        <div class="col-sm-12 col-md-7">
                            ...
                            <a class="btn btn-borders custom-border-width btn-primary custom-border-radius font-weight-semibold text-uppercase mt-xlg"
                               href="<?php echo base_url_lang();?>" title="<?php echo trans_line('news_button');?>"><?php echo trans_line('news_button');?></a>
                        </div>
                    </article>
                </div>
            </div>
                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <div class="col-md-6 pl-none">
                            ...
                            <a href="tel:<?php echo TEL_VENTAS;?>" class="text-decoration-none" target="_blank" title="<?php echo trans_line('know_call');?>">
                    ...
                    <div class="col-md-6 custom-sm-margin-top">
                        ...
                        <form id="contactForm" class="custom-contact-form-style-1" action="<?php echo base_url_lang();?>contacto/enviar"
                              method="POST">
                            <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        <div class="custom-input-box">
                                            ...
                                            <input type="email" value=""
                                                   ...
                                                   class="form-control" name="email" id="email" placeholder="<?php echo trans_line('form_mail');?>"
                                                   required>
                                        </div>
                                    </div>
                                </div>
